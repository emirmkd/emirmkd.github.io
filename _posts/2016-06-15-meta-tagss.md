...
<p style="weight: bold;">PROTIP: If you want to highlight Liquid code inside of Jekyll, just write {{ "{% raw "}}%} before adding the highlighted code and {{ "{% endraw "}}%} when you want to finish it. </p>
